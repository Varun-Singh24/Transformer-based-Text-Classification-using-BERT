...
- **BERT-base** – Bidirectional contextual embeddings for deep language understanding  
- **DistilBERT-base** – Optimized, lightweight version of BERT with faster inference  
- **RoBERTa-base** – Robustly optimized BERT with improved pretraining strategy  
